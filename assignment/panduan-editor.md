...
Setiap halaman study case memiliki editor Python yang berjalan langsung di browser (Pyodide), tanpa perlu install apa pun. Editor ini punya tiga tombol: **Run**, **Reset**, dan **Run Tests**. Ketiganya punya fungsi yang berbeda. Halaman ini menjelaskan kapan memakai yang mana.
